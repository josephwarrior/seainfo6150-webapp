...
const Article = () => {
  return (
    <html lang="en">
      <head>
        <meta charset="utf-8" />
        <title>Kate Farley Article</title>
      </head>
      <body>
        <div>
          ...
          <p>
            ...
            <br />
            <br /> But visitors will be able to see the original 3,600-pound
            torch in all its glory at a new Statue of Liberty Museum, which will
            open on Liberty Island in May 2019. The torch was transported there
            by truck last week, along with a replica model of Lady Liberty's
            face.
            <br />
            <br /> "Although it is not one of the most difficult things we have
            ever moved," says Douglas Phelps, who oversaw the relocation of the
          ...
          <p>
            ...
            <br />
            <br /> Her full name is Liberty Enlightening the World, and she was
            designed by Frederic Auguste Bartholdi and built by Gustave Eiffel
            -- yes, the same guy who built Paris's Eiffel Tower.
            <br />
            <br /> Lady Liberty was a gift from France to the United States to
